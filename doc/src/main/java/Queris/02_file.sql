insert into files (id, name, path) values (1, 'slider3.jpg', 'slider3.jpg');
insert into files (id, name, path) values (2, 'slider2.jpg', 'slider2.jpg');
insert into files (id, name, path) values (3, 'shoes_cat.png', 'shoes_cat.png');
insert into files (id, name, path) values (4, 'Blue_Tshirt.png', 'Blue_Tshirt.png');
